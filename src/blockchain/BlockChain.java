...
public class BlockChain {
	...
	public static void main(String[] args) {	
		...
		genesisTransaction = new Transaction(coinbase.publicKey, walletA.publicKey, 150f, null);
		...
		System.out.println("\nWalletB is Attempting to send funds (60) to WalletB...");
		block4.addTransaction(walletA.sendFunds( walletB.publicKey, 60));
		addBlock(block4);
		System.out.println("\nWalletA's balance is: " + walletA.getBalance());
		System.out.println("WalletB's balance is: " + walletB.getBalance());
		System.out.println("WalletC's balance is: " + walletC.getBalance());
		...
		System.out.println("\nWalletB is Attempting to send funds (40) to WalletB...");
		block5.addTransaction(walletA.sendFunds( walletB.publicKey, 40));
		System.out.println("\nWalletA's balance is: " + walletA.getBalance());
		System.out.println("WalletB's balance is: " + walletB.getBalance());
		System.out.println("WalletC's balance is: " + walletC.getBalance());
